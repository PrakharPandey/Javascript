...
const fs = require('fs')
var obj = null, a, fin = [], fin2 = [], fin3 = [], fin4 = {}, fin5 = []
...
rl.on('close', () => {
    fs.createWriteStream('Part1.json').write(JSON.stringify(fin, null, 2), 'UTF8')
    fs.createWriteStream('Part2.json').write(JSON.stringify(fin2, null, 2), 'UTF8')
    var sum = []
    ...
    fs.createWriteStream('Part3.json').write(JSON.stringify(fin5, null, 2), 'UTF8')
})